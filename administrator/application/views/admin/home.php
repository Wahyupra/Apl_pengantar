  ...
  <div class="container">
    ...
    <section class="content-header">
      <h1>
        ...
        <center>
          <small>Aplikasi Pelayanan Masyarakat</small>
        </center>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      <div class="callout callout-danger">
        <div class="callout callout-danger" style="margin-bottom: 0!important;">
          <center>
            <h4><i class="fa fa-institution"></i> Selamat Datang Di Halaman Administrator Aplikasi Surat Pengantar RT RW berbasis WEB: <i class="fa fa-institution"></i></h4>
          </center>
          <p>
            <center>Halaman Admin ini Berfungsi Untuk Validasi, Input data Penduduk, Cetak Pengantar dan pengontrolan Surat Pengantar Yang Masuk.</center>
          </p>
        </div>
      </div>
