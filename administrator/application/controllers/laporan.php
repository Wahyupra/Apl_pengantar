...
class Laporan extends CI_Controller
{
    ...
    function laprec($no)
    {
        ...
        if ($data != 'NO_DATA_QUERY') {
            ...
            $pdf->Ln(5);
            $pdf->Cell(0, 0, 'KECAMATAN SEMARANG SELATAN ', 0, 0, 'C');
            $pdf->Ln(5);
            $pdf->Cell(0, 0, 'KELURAHAN LAMPER LOR ', 0, 0, 'C');
            $pdf->Ln();
            $pdf->SetFont('Arial', 'i', 9);
            $pdf->Cell(106, 12, 'Alamat: Jl. Cempedak Raya No.8', 0, 0, 'C');
            $pdf->Cell(15, 12, 'Tlp: (024) 8415926', 0, 0, 'R');
            $pdf->Cell(50, 12, 'Code Pos: 50249', 0, 0, 'R');
            $pdf->Ln(0);
            ...
            $pdf->Cell(60, 4, 'Camat Semarang Selatan', 0, 0, 'R');
            $pdf->Cell(62, 4, 'Lurah Lamper Lor', 0, 0, 'R');
            $pdf->Ln(25);
            $pdf->Cell(29, 4, '' . $nama, 0, 0, 'C');
            $pdf->Cell(60, 4, 'Eko Wiwi Yuniarto', 0, 0, 'R');
            $pdf->Cell(93, 4, 'Noor Ali Taufiq', 0, 0, 'R');
            $pdf->setlinewidth(0.3);
    ...
    function cetak($no)
    {
        ...
        if ($data != 'NO_DATA_QUERY') {
            ...
            $pdf->Cell(33, 4, 'Kelurahan Lamper Lor', 0, 0, 'R');
